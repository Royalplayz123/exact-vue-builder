...
import { Check, Clock, Wifi, Download, Upload, Monitor, Globe, Shield, Folder, MapPin, Sparkles, Server, Zap, HardDrive } from 'lucide-react';

import palworldBanner from '@/assets/palworld-banner.jpg';
import lamballIcon from '@/assets/pals/lamball.png';
import direhowlIcon from '@/assets/pals/direhowl.png';
import anubisIcon from '@/assets/pals/anubis.png';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${palworldBanner})` }}
        >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-2 animate-fade-in" style={{ animationDelay: '100ms' }}>
            <span className="text-primary">PALWORLD</span>
          </h1>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-10 text-sm max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '100ms' }}>
            Monitor our network performance in real-time. We guarantee the best gaming experience for PALWORLD.
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 max-w-2xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-lg p-4 text-center animate-fade-in" style={{ animationDelay: '200ms' }}>
              ...
              <div className="text-xl font-bold text-cyan-400">&lt;14ms</div>
      ...
      <section id="plans" className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-4 animate-fade-in">
            CHOOSE YOUR <span className="text-primary">PAL PLAN</span>
          </h2>
          <p className="text-muted-foreground text-center mb-10 text-sm max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '100ms' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className={`bg-gradient-to-r ${plan.color === 'yellow' ? 'from-yellow-600/20 to-yellow-400/20' : 'from-cyan-600/20 to-cyan-400/20'} p-6 flex justify-center`}>
                  <img 
                    src={plan.image} 
                    alt={plan.name}
                ...
                <div className="text-center py-3">
                  <h3 className={`text-lg font-bold ${plan.color === 'yellow' ? 'text-yellow-400' : 'text-cyan-400'}`}>{plan.name}</h3>
                </div>
