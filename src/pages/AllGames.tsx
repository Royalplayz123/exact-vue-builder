...
const supportFeatures = [
  { icon: MessageCircle, title: '24/7/365 SUPPORT', desc: 'At Codenest, we offer 24/7/365 support through our live chat and ticket services. Get help instantly from our chat or submit a ticket with any questions or concerns you may have, and get answers in an average 15 minutes.' },
  { icon: Users, title: 'EXPERIENCED STAFF', desc: 'Codenest has been building and playing on game servers for many years. Our team of professionals are experts in game server hosting and are always ready to help!' },
  { icon: Sparkles, title: 'PERSONALIZED SUPPORT', desc: 'At Codenest, we skip the automated messages and chatbots to connect you right to a server hosting expert. Get personalized help for your specific setup and requirements.' },
];
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-10">
              ...
              <span className="gradient-text-purple">CODENEST</span>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-6">
                  With a Codenest server, play your game however you want, wherever you want, with whoever you want, thanks to our crossplay support. Stick to your platform of choice to keep things comfortable while customizing the experience to your needs.
                </p>
          ...
          <div className="container mx-auto">
            <div className="relative p-8 md:p-12 rounded-2xl bg-gradient-to-r from-primary/20 to-purple-600/20 border border-primary/30 text-center overflow-hidden">
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                Join thousands of gamers hosting their servers with Codenest. Instant setup, 24/7 support.
              </p>
